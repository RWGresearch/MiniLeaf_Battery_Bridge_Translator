this code has been compleatly re configured for a difrent project by RWGresearch to be used on the Mini Leaf Conversion. 
The below is for refrance on the orgnial sorce code. however some or most of the later is no longer used or the same. its left here in place for any LICENSE requirements. 

all the new code dose: 
